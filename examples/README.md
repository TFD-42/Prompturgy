...
Runnable demonstrations of Pro-Prompt's CLI, REST API, and configuration. All
...
| [`rest_api.sh`](rest_api.sh) | Driving the web UI's REST endpoints directly with `curl` — useful for scripting or integrating Pro-Prompt into another tool |
| [`alternate_backend.md`](alternate_backend.md) | Pointing Pro-Prompt at LM Studio / text-generation-webui / GPT4All instead of Ollama |
